...
import numpy as np
from algo_engine.base import TradeData
    ...
    with open(file_path, 'r') as f:
        ...
        for row in data_file:  # type: dict[str, str | float]
            trade_data = TradeData(
                ...
                timestamp=datetime.datetime.combine(market_date, datetime.time(*map(int, row['Time'].split(":"))), tzinfo=GlobalStatics.TIME_ZONE).timestamp(),
                side=row['Type'],
