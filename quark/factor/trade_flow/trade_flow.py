...
class TradeFlowMonitor(FactorMonitor, FixedIntervalSampler):
    ...
    def __init__(self, sampling_interval: float, sample_size: int, name: str = 'Monitor.trade_flow', monitor_id: str = None):
...
class TradeFlowAdaptiveMonitor(TradeFlowMonitor, AdaptiveVolumeIntervalSampler):
    ...
    def __init__(self, sampling_interval: float, sample_size: int = 20, baseline_window: int = 100, aligned_interval: bool = False, name: str = 'Monitor.trade_flow.Adaptive', monitor_id: str = None):
        super().__init__(
...
class TradeFlowAdaptiveIndexMonitor(TradeFlowAdaptiveMonitor, Synthetic):
    ...
    def __init__(self, sampling_interval: float, sample_size: int, baseline_window: int, aligned_interval: bool = False, weights: dict[str, float] = None, name: str = 'Monitor.trade_flow.Adaptive.Index', monitor_id: str = None):
        super().__init__(
            sampling_interval=sampling_interval,
            sample_size=sample_size,
            baseline_window=baseline_window,
