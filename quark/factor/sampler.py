...
from typing import Self, Literal, overload, Any, TypedDict
...
__all__ = ['SamplerMode', 'SamplerData', 'MarketDataSampler', 'FixedIntervalSampler', 'FixedVolumeIntervalSampler', 'AdaptiveVolumeIntervalSampler']
...
class MarketDataSampler(object, metaclass=abc.ABCMeta):
    ...
    def log_obs(self, ticker: str, timestamp: float, observation: dict[str, ...] = None, auto_register: bool = True, **kwargs):
        ...
        Args:
            ...
            auto_register (bool, optional): Whether to automatically register the observation. Defaults to True.
...
class FixedIntervalSampler(MarketDataSampler, metaclass=abc.ABCMeta):
    ...
    def log_obs(self, ticker: str, timestamp: float, observation: dict[str, ...] = None, **kwargs):
        ...
        for topic, obs_value in observation_copy.items():
            ...
            ts_idx: int = sampler_data.index[ticker]
...
class FixedVolumeIntervalSampler(FixedIntervalSampler, metaclass=abc.ABCMeta):
    ...
    @overload
    def accumulate_volume(self, market_data: MarketData, use_notional: bool = False):
        ...
...
class AdaptiveVolumeIntervalSampler(FixedVolumeIntervalSampler, metaclass=abc.ABCMeta):
    ...
    Attributes:
        ...
        _volume_baseline (Dict[str, Union[float, Dict[str, float], Dict[str, float], Dict[str, Dict[float, float]]]]): Dictionary containing baseline information.
    ...
    def __init__(self, sampling_interval: float = 60., sample_size: int = 20, baseline_window: int = 100, aligned_interval: bool = True):
        ...
        self._volume_baseline = self.VolumeBaseline(
            baseline={},
            sampling_interval={},
            obs_vol_acc_start={},
            obs_index={},
